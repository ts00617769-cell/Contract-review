...
export default async function HomePage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 pb-20 pt-8 md:pt-12">
      ...
      <header className="mx-auto mb-14 max-w-4xl pt-20 text-center md:pt-28">
        ...
        <h1 className="mt-6 text-balance text-4xl font-semibold leading-[1.15] tracking-[-0.04em] text-zinc-950 dark:text-white sm:text-5xl md:text-6xl">
          別再簽「改到滿意為止」的合約了。
        </h1>
